...
func (s *Solver) Depsolve(pkgSets []rpmmd.PackageSet, withSbom bool) ([]rpmmd.PackageSpec, []rpmmd.RepoConfig, *sbom.Document, error) {
	...
	case sbom.StandardTypeSpdx:
		sbomDoc, err = sbom.NewDocumentFromSpdxJSON(result.Sbom)
	}
